...
def main():
    ...
    if not matches.empty:
        ...
        print(f">> Total Value at Risk: ${total_risk:,.2f}" if isinstance(total_risk, (int, float)) else f">> Total Value at Risk: {total_risk}")

    else:
        print(f"✅ No immediate disruptions found in D.csv for {target_port}.")
